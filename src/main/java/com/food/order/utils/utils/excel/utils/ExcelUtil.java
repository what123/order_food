package com.food.order.utils.utils.excel.utils;
...
import com.food.order.utils.utils.excel.exception.ExcelException;
...
public class ExcelUtil {
     ...
     */
    public static <T extends BaseRowModel> void writeExcel(String filePath, List<T> list,
                                                           String fileName, String sheetName, ExcelTypeEnum excelTypeEnum,
                                                           Class<T> classType)  throws ExcelException {
