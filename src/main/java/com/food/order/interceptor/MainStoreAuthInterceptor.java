 ...
 */
public class MainStoreAuthInterceptor implements HandlerInterceptor {
    @Autowired
...
//        System.out.println("sessionid22++++++++++++++++++++++++++++++"+sessoin.getId());
        ...
        if(user == null || user.isDelete() || user.getBelong() != 2){
        ...
        MainStore mainStore = mainStoreRepository.findOne(criteria).orElse(null);
        if(mainStore == null){
        ...
        request.setAttribute("user",mainStore);
        return true;
    }
